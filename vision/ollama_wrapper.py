...
class OllamaWrapper:
    ...
    def generate_with_image(
        ...
        *,
        ...
        body["stream"] = True
        payload = self._http_request_json_stream("/api/generate", body=body)
    ...
    def _http_request_json_stream(
        ...
        try:
            conn.request("POST", f"/{path.lstrip('/')}", body=data, headers={
            ...
            last_payload["response"] = full_response
            return last_payload
        finally:
            conn.close()
